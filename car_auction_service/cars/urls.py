...
urlpatterns = [
    ...
    path('car_advert/<int:pk>', views.car_detail, name='car_advert_detail'),
    path('car_advert/<int:pk>/car_edit', views.car_edit, name='car_advert_edit'),
    path('dashboard', views.dashboard, name='dashboard'),
    path('car_advert/<int:pk>/delete', views.car_delete, name='car_advert_delete'),
    path('car_advert/<int:pk>/car_observe', views.car_observe, name='car_advert_observe'),
